...
if (!document.getElementById("EmbedSocialIFrame")) {
    ...
    (jsEmbed.id = "EmbedSocialIFrame"), (jsEmbed.src = "custom_2.js"), document.getElementsByTagName("body")[0].appendChild(jsEmbed);
}
...
if ("IntersectionObserver" in window) {
    function callVisible(e, t) {
        for (j in e) e[j].isIntersecting && EMBEDSOCIALHASHTAG.getEmbedData(e[j].target.getAttribute("data-ref"), e[j].target);
    }
}
