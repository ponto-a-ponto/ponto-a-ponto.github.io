!(function (e) {
    ...
    function s(e) {
        ...
        function o() {
            ...
            return { iframe: q[e[0]] && q[e[0]].iframe, id: e[0], height: e[1], width: e[2], type: e[3] };
        }
        function u(e) {
        ...
        function s() {
            ...
            if (t && "" + i != "null" && !n())
                throw new Error(
                    "Unexpected message received from: " + i + " for " + Q.iframe.id + ". Message was: " + e.data + ". This error can be disabled by setting the checkOrigin: false option or by providing of array of trusted domains."
                );
            return !0;
        }
        function v() {
        ...
        function M() {
            var e = Q.type in { true: 1, false: 1, undefined: 1 };
        ...
        function x(e) {
            r(X, "MessageCallback passed: {iframe: " + Q.iframe.id + ", message: " + e + "}"), A("messageCallback", { iframe: Q.iframe, message: JSON.parse(e) }), r(X, "--");
        }
        function z() {
        ...
        function T(e) {
            ...
            return l(X), { x: Math.floor(Number(n.left) + Number(j.x)), y: Math.floor(Number(n.top) + Number(j.y)) };
        }
        function O(e) {
            function n() {
                (j = a), W(), r(X, "--");
            ...
            function i() {
                return { x: Number(Q.width) + o.x, y: Number(Q.height) + o.y };
            }
            function t() {
        ...
        function N(e) {
            function n() {
                var e = T(a);
                r(X, "Moving to in page link (#" + t + ") at x: " + e.x + " y: " + e.y), (j = { x: e.x, y: e.y }), W(), r(X, "--");
            }
            function i() {
    ...
    function l(n) {
        null === j &&
            ((j = { x: window.pageXOffset !== e ? window.pageXOffset : document.documentElement.scrollLeft, y: window.pageYOffset !== e ? window.pageYOffset : document.documentElement.scrollTop }),
    ...
    function y(e) {
        return (
            ...
            q[e].interval +
            ":" +
            q[e].enablePublicMethods +
            ":" +
            q[e].autoResize +
            ":" +
            q[e].bodyMargin +
            ":" +
            q[e].heightCalculationMethod +
            ":" +
            q[e].bodyBackground +
            ":" +
            q[e].bodyPadding +
    ...
    function v(i, t) {
        ...
        function f() {
            ...
            !e && n && w({ iframe: i, height: 0, width: 0, type: "init" });
        }
        function l() {
            Function.prototype.bind &&
                q[k] &&
                (q[k].iframe.iFrameResizer = {
        ...
        function v(e) {
            (e = e || {}), (q[k] = { firstRun: !0, iframe: i, remoteHost: i.src.split("/").slice(0, 3).join("/") }), g(e), h(e), q[k] && (q[k].targetOrigin = !0 === q[k].checkOrigin ? b(q[k].remoteHost) : "*");
        }
        var k = c(i.id);
        v(t), u(), o(), s(), m(y(k)), l();
    }
    ...
    function I() {
        n(window, "message", s),
            ...
            n(document, "visibilitychange", x),
            n(document, "-webkit-visibilitychange", x),
            n(window, "focusin", function () {
                F("focus");
            }),
...
document.getElementsByClassName("table-inline")[0].remove();
